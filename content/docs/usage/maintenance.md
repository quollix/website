...
Automatic updates for third-party apps install future versions from the [App Store]({{< relref "docs/usage/app-store/" >}}) without manual review. Enable them only for app maintainers you trust.
