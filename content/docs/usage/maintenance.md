...
The Maintenance Agent runs once a day according to the configuration on the [Maintenance Settings]({{< relref "settings/maintenance.md" >}}) page. On this page, you select which apps are included in automatic updates and automatic backups.
